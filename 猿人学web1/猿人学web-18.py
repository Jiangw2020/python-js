...
with open('猿人学web-18.js', 'r+', encoding='utf-8') as f:
    js_code = f.read()
...
cookies = {
    ...
    'm': '42166e3687b6cf9e6eb15fa3a1f23a0d|1759754478000|14078035824000|1',
}
...
for page in range(1, 6):
    ...
    print(params)
    response = client.get('https://match.yuanrenxue.cn/match/18data', params=params, cookies=cookies, headers=headers)
    print(response.text)
