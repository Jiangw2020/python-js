...
cookies = {
    ...
    'm': '9770db9a704b53391faa86373e14ad8e|1759717803000|14077742424000|1',
}
...
for page in range(1, 6):
    ...
    response = client.get('https://match.yuanrenxue.cn/api/match/17', params=params, headers=headers, cookies=cookies)
    print(response.text)
