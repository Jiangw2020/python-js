...
cookies = {
    ...
    'm': 'b5656e3a64bd572e371b003c280b55d3|1759800585000|14078404680000|1',
    'qpfccr': 'true',
    'no-alert3': 'true',
}
...
for page in range(1, 6):
    ...
    response = client.get('https://match.yuanrenxue.cn/api/match/19', params=params, cookies=cookies, headers=headers)
    print(response.text)
